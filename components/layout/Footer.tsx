...
const Footer = () => {
  return (
    <footer className="mb-18 lg:mb-0 bg-crimsonRed text-white p-6 lg:px-24 lg:h-100 text-center lg:text-left flex flex-col lg:flex-row items-center justify-center lg:justify-between gap-3">
